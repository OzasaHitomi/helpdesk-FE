...
// detailは403/500/422(BUSINESS_ERROR)では文字列、422(VALIDATION_ERROR)ではValidationErrorResponseItemの配列になる
// typeは422('VALIDATION_ERROR'・'BUSINESS_ERROR')・500('INTERNAL_SERVER_ERROR')は専用の例外ハンドラで付与されるが、
...
export type ErrorResponse = {
  ...
  type?: 'VALIDATION_ERROR' | 'INTERNAL_SERVER_ERROR' | 'BUSINESS_ERROR'
}
