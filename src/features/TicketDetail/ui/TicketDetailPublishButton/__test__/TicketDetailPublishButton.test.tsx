import { TicketDetailPublishButton } from '../TicketDetailPublishButton'
import { customRender } from '@/tests/helpers/customRender'
import { describe, it, expect, vi, afterEach } from 'vitest'
import { screen, fireEvent } from '@testing-library/react'

// TicketDetailPublishButtonの表示内容(選択状態・disabled)と、ボタン押下時にhandlers.onClickが
// 呼ばれるかのみをテストする
...
describe('TicketDetailPublishButton', () => {
  afterEach(() => {
    vi.clearAllMocks()
  })
