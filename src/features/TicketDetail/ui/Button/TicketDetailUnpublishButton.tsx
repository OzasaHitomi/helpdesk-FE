...
interface TicketDetailUnpublishButtonProps {
  isSelected: boolean
  isEditable: boolean
  disabled: boolean
  handlers: {
...
// 公開設定の「非公開」ボタン（見た目専用のコンポーネント。公開への切り替えはTicketDetailPublishButtonが担当）
export const TicketDetailUnpublishButton = ({
  isSelected,
  isEditable,
  disabled,
  handlers,
}: TicketDetailUnpublishButtonProps) => {
  return (
    <Button
      size={'sm'}
      w={'3xs'}
